...
wxy, err = equalisation.equalise_signal(SS, mu, Ntaps=ntaps, method="cma", adaptive_step=True)
wxy_m, err_m = equalisation.equalise_signal(SS, mu, Ntaps=ntaps, method="mcma", adaptive_step=True)
