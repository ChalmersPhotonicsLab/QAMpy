...
def run_pilot_receiver(rec_signal, pilot_symbs, pilot_seq_len, resample_rate = (2.5,2) ):
...
eq_pilots, corr_pilots, symbs_out, phase_trace, shift_factor = run_pilot_receiver(rec_signal, pilot_symbs, pilot_seq_len)
