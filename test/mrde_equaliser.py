...
E_m, (wx_m, wy_m), (err_m, err_rde_m) = equalisation.dual_mode_equalisation(SS, os, (muCMA, muRDE), M, ntaps, TrSyms=(Ncma, Nrde), methods=("mcma_adaptive","cma" ))
(wx, wy), err = equalisation.equalise_signal(SS, os, muCMA/100, M, Ntaps=ntaps, TrSyms=None, Niter=2, method="sca")
Ex, Ey = equalisation.apply_filter(SS, os, (wx,wy))
E = np.vstack([Ex, Ey])
