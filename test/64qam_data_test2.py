...
SS = np.vstack([X[500000:-500000],Y[500000:-500000]])
...
(wx, wy), err_cma = equalisation.MCMA_LMS(SS, 4, 2, muCMA, M, ntaps)
wxdd = wx.copy()
wydd = wx.copy()
(wxdd, wydd), err_dd = equalisation.SBD_LMS(SS, 4, 2, muRDE, M, (wx,wy))
