...
@numba.jit(nopython=True)
def FS_MRDE(E, TrSyms, Ntaps, os, mu, wx, part, code, adaptive=False):
    """
...
@numba.jit(nopython=True)
def FS_SBD(E, TrSyms, Ntaps, os, mu, wx, symbols, adaptive=False):
    """
...
@numba.jit(nopython=True)
def FS_MDDMA(E, TrSyms, Ntaps, os, mu, wx, symbols, adaptive=False):
    """
...
@numba.jit(nopython=True)
def FS_RDE(E, TrSyms, Ntaps, os, mu, wx, part, code, adaptive=False):
    """
...
@numba.jit(nopython=True)
def FS_CME(E, TrSyms, Ntaps, os, mu, wx, R, d, beta, adaptive=False):
...
@numba.jit(nopython=True)
def FS_SCA(E, TrSyms, Ntaps, os, mu, wx, R, adaptive=False):
    """Constellation matched error algorithm after _[1]
